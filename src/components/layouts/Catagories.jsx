              ...
              <div className="absolute bottom-10 left-10">
                ...
                <div className="group relative mt-2">
                  <Link to={"/"}>
                    ...
                    />
                    <span className="block absolute bottom-[-5px] left-0 bg-black w-[50px] h-[2px]">
                      <span className="block absolute bottom-0 left-[50px] bg-black w-0 h-[2px] group-hover:w-5 transition-[width] ease-in-out duration-300"></span>
                    </span>
                  </Link>
                </div>
              </div>
